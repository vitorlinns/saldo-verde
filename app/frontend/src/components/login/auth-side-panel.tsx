export default function AuthSidePanel() {
  return (
    <div className="hidden lg:flex relative overflow-hidden bg-background lg:min-h-screen lg:items-center lg:justify-center lg:px-12 lg:py-14">
      ...
      <div className="relative mx-auto max-w-lg space-y-4 pl-5 sm:pl-6 lg:space-y-5 lg:pl-0">
