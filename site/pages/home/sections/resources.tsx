      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-10">
        <div className="grid gap-6 xl:grid-cols-[1.2fr_1fr]">
          <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white/95 shadow-sm shadow-slate-200/40">
            <div className="relative w-full aspect-[16/9] bg-slate-100/70 sm:aspect-[16/9]">
              <Image
            ...
            <div className="p-8 pt-8">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-base font-semibold tracking-tight text-slate-950 sm:text-3xl">
